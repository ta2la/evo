...
//===================================================================
Cmd_draw_refBox::Cmd_draw_refBox(void) :
    Cmd("draw ref_line"),
    gid0_(0)
{
}
...
//===================================================================
void Cmd_draw_refBox::enterPoint( const Point2F& pt, Display& view )
{	UpdateLock l;
    ...
    if (points_.count() == 0) {
        ...
        CadObject_refBox* line = new CadObject_refBox(Point2FCol(), file);
...
//===================================================================
void Cmd_draw_refBox::enterReset( Display& view )
{
    points_.clean();
...
//===================================================================
void Cmd_draw_refBox::enterMove( const Point2F& pt, Display& view )
{   
...
//===================================================================
QString Cmd_draw_refBox::dialogTml() const
{
    QString result;
...
//===================================================================
QString Cmd_draw_refBox::hint(void) const
{
    if (points_.count() == 0) {
