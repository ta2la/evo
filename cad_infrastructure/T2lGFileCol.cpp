...
//====================================================================
 ...
 {
     static GFileCol* instance_ = nullptr;
 ...
 //====================================================================
 void GFileCol::shift(int index, bool down)
 {
     if (count() <= 1) return;
     if (index==0 && !down) return;
     if (index>=count()-1 && down) return;
     if (index < 0) { assert(0); return; }

     GFile* temp = get(index);
     int otherIndex = index-1;
     if (down) otherIndex = index+1;
     set(index, get(otherIndex));
     set(otherIndex, temp);
 }
