...
bool FilterCadObject::pass(TcObject* object)
{
    ...
    return displable->isOfType(type_);

    /*
    switch (type_)
    {
    case ECO_LINE:    if ( (dynamic_cast<CadLine*>(object)           == nullptr) &&
                          (dynamic_cast<CadObject_linePro*>(object) == nullptr) ) return false; break;
    ...
    //APTA case ECO_TEXTBOX: if (dynamic_cast<CadObject_textBox*>(object)   == nullptr) return false; break;
    }
    */
