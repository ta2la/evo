...
//===================================================================
class CadObject_refLine : public ObjectDisplable {
//===================================================================
public:
//<CONSTRUCTION>
    CadObject_refLine( const Point2Col<double>& points, GFile* parent, int gid = 0);
    ~CadObject_refLine(void);
...
//<DATA>
    int update_;
// <INTERNALS>
    Point2F display_cut_(Point2F& p0, Point2F& p1, Box2F& box );
};
