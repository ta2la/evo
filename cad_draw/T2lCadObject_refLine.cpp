...
//===================================================================
void CadObject_refLine::recalculate(void)
{
...
//===================================================================
Point2F CadObject_refLine::display_cut_(Point2F& p0, Point2F& p1, Box2F& box )
{
    Line2 line(p0, p1);
...
void CadObject_refLine::display(EntityList& list, RefCol* scene)
{
    ...
    // <STEP>
    EntityLine* linee = new EntityLine( Color(100,100,100), 0.8 );
    linee->points().points().add( p0 );
    linee->points().points().add( p1 );
    list.add( linee );
    ...
    EntityText* text = new EntityText( str, pc,
           ...
           Style::createTextStyle(Color::GRAY, 1.5, "", false), true);
    list.add(text);
...
//=========================================================================
void CadObject_refLine::saveToStored(StoredItem& item, [[maybe_unused]] GFile* file)
{
