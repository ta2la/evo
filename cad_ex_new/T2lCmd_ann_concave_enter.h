...
//===================================================================
class Cmd_ann_concave_enter : public T2l::Cmd {
//===================================================================
public:
    Cmd_ann_concave_enter(void);
    virtual ~Cmd_ann_concave_enter(void);
//===================================================================
    ...
    static Point2FCol fitEllipse(const Point2FCol& points);
    static Point2FCol concave_calc(Point2FCol& points);
